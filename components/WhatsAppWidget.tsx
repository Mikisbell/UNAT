...
export default function WhatsAppWidget() {
  ...
  return (
    <>
      {/* Widget Button - Más llamativo y animado */}
      <motion.div className="fixed bottom-6 right-6 z-50">
        <motion.button
          onClick={() => setIsOpen(!isOpen)}
          className="relative w-20 h-20 bg-gradient-to-br from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 rounded-full shadow-2xl flex items-center justify-center text-white transition-all group"
        ...
        >
          ...
          <motion.div 
            className="absolute -top-2 -right-2 w-7 h-7 bg-red-500 rounded-full flex items-center justify-center text-xs font-bold"
        ...
        <motion.div
          ...
          transition={{ delay: 1 }}
          className="absolute right-24 top-1/2 transform -translate-y-1/2 bg-white text-primary-900 px-4 py-2 rounded-lg shadow-lg whitespace-nowrap font-bold text-sm"
        >
          ¿Dudas? ¡Chatea ahora!
          <div className="absolute right-0 top-1/2 transform translate-x-2 -translate-y-1/2 w-3 h-3 bg-white rotate-45" />
        </motion.div>
      </motion.div>
